...
class ConnectorManager
{
	...
	public function connect($params)
	{
		$className = 'WR\\Connector\\' . $this->myConnector . '\\' . ucfirst($this->myClass);
		$classInstance = new $className($params);
		return $classInstance->connect($params);
	}
	 ...
	 * @return mixed
	 */
	public function isLogged($params)
	{
		$className = 'WR\\Connector\\' . $this->myConnector . '\\' . ucfirst($this->myClass);
		$classInstance = new $className($params);
		return $classInstance->isLogged($params);
	}
	...
	public function customVariablesList($params)
	{
		$className = 'WR\\Connector\\' . $this->myConnector . '\\' . ucfirst($this->myClass);
		$classInstance = new $className($params);
		return $classInstance->customVariablesList($params);
	}
	...
	public function customVariablesAdd($params)
	{
		$className = 'WR\\Connector\\' . $this->myConnector . '\\' . ucfirst($this->myClass);
		$classInstance = new $className($params);
		return $classInstance->customVariablesAdd($params);
	}
	...
	public function formSuiteAdd($params)
	{
		$className = 'WR\\Connector\\' . $this->myConnector . '\\' . ucfirst($this->myClass);
		$classInstance = new $className($params);
		return $classInstance->formSuiteAdd($params);
	}
}
